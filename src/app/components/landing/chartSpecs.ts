// Chart specifications and data for the landing page

// Demo timeline chart data
...
export const dashboardChartSpec = {
  type: 'bar',
  data: {
    values: [
